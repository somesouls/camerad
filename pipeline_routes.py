...
konteks request (Ctx/build_ctx), helper artefak/HTTP/XLSX, langkah step1..step11,
integrasi avaya*, dispatch aksi, unduhan, chat LLM, serta rute UI (/,/tools,
/api/config,/api/chat). Migrasi langkah 6 (final) dari web_app.py.

Daftarkan dengan:  import pipeline_routes; pipeline_routes.register(app)
Helper di modul ini juga di-inject ke awe_routes.register() dari web_app.py.
"""
import os
import re
import io

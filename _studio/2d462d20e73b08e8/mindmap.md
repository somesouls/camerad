- Pembagian Rich Content Juli 2026
  - Penugasan
    - Intent
    - PIC
    - Progress
  ...
  - Template
    ...
    - Link
  - Dian
    - KUP_PKP_Pengukuhan Melalui Coretax
      - Pembuka
      - Payload
        - Login Aplikasi Portal
        - Menu Portal Saya
        - Pengukuhan PKP/VAT Registration
        - Status kepemilikan tempat usaha
        - Data pendapatan tahunan
        - Bulan mulai pemungutan PPN
        - Alamat cabang di luar FTZ
        - Pernyataan
  - Topik dan menu bantuan
    - Pelaporan SPT
    - Perubahan Data
    - Konfirmasi NPWP
    ...
    - Daftar NPWP
    - Lupa EFIN
    - Lupa EFIN Belum Aktivasi
    - Lupa EFIN Sudah Aktivasi
    - Mengaktifkan Kembali/Penonaktifan NPWP
    - Cetak NPWP
    - Kode Error Coretax
  ...
  - Informasi layanan
    ...
    - Survei layanan
      - https://s.kemenkeu.go.id/surveiDJPVA
  - Ketentuan umum
    - Jawaban VA bukan dasar hukum
    - Simpan transkrip percakapan
  - Lupa EFIN
    - Status aktivasi EFIN
      - Sudah aktivasi
      - Belum aktivasi
    - Cara memperoleh kembali EFIN
      - M-Pajak
  ...
  - Coretax
    ...
    - Dokumen saya
    - Unduh dokumen
    - Generating document is in progress
  - E-Faktur
    - E-Faktur Desktop
    - E-Faktur Web
    - Password e-Nofa
